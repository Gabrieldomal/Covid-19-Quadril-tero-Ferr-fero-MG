dados <- read.csv("C:/Users/James Bond/Desktop/Gitlab/dsl/programs/python/Leitos_OP/tabela_meso.csv")
...
ggplot(data = y_fitted, aes(x = index, y = fit))+ #Dados passados (observados)
  ...
  ylim(-100, 14500)+ #Determinar limite de Y
  xlim(0, 101) #determinar limite de X
